...
<html lang="zh-cn">
	<head>
		...
		<title>安装米云微营销系统 - 米云微营销 - 公众平台自助开源引擎</title>
	...
	echo <<<EOF
		<div class="panel panel-default">
			...
			<div class="panel-body" style="overflow-y:scroll;max-height:400px;line-height:20px;">
				<h3>版权所有 (c)2014-2017，米云微营销系统团队保留所有权利。 </h3>
				<p>
					感谢您选择米云微营销系统 - 微信公众平台自助开源引擎（以下简称米云微营销，米云微营销基于 PHP + MySQL的技术开发，全部源码开放。 <br />
					为了使你正确并合法的使用本软件，请你在使用前务必阅读清楚下面的协议条款：
				</p>
				<p>
					<strong>一、本授权协议适用且仅适用于米云微营销系统(米云微营销. 以下简称米云微营销)任何版本，米云微营销官方对本授权协议的最终解释权。</strong>
				</p>
				<p>
				...
				<p>
					...
					<ol>
						...
						<li>未经官方许可，禁止在米云微营销系统的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。</li>
				...
				<p>
					...
					<ol>
						...
						<li>电子文本形式的授权协议如同双方书面签署的协议一样，具有完全的和等同的法律效力。您一旦开始确认本协议并安装 米云微营销系统，即被视为完全理解并接受本协议的各项条款，在享有上述条款授予的权力的同时，受到相关的约束和限制。协议许可范围以外的行为，将直接违反本授权协议并构成侵权，我们有权随时终止授权，责令停止损害，并保留追究相关责任的权力。</li>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						...
						<div class="help-block">
							安装米云微营销系统, 如果不是在米云网络官方获得的安装包, 很有可能被植入木马，请不要安装. <br/>
							如果你想安装最新版程序,可以现在联系米云官方客服QQ：1107710272 获取最新安装包.
						</div>
					</div>
				</div>
			</div>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input class="form-control" type="text" name="db[name]" value="symiyun.com">
					</div>
				</div>
			</div>
		</div>
...
function tpl_install_finish() {
	...
	<div class="alert alert-success">
		恭喜您!已成功安装“米云微营销系统 - 公众平台开源引擎”系统，您现在可以: <a target="_blank" class="btn btn-success" href="./web/index.php?c=user&a=login&">访问网站首页</a>
		<br />
	</div>
