...
<div class="row state-overview" style="margin-left:-15px;margin-right:-15px; margin-top:15px;">
  ...
  <div class="col-lg-4 col-sm-10">
    ...
    <div class="panel panel-default" style=" height:280px;overflow:hidden; padding:0 15px;">
					...
					<h5 style="font-size:16px; color:#FF6C60;">产品动态</h5>

					<div style="height:220px;  overflow:hidden;">
                    <?php  if(is_array($news)) { foreach($news as $new) { ?>

					 <li style="height:22px; line-height:22px; color:#999;"><a target="_blank" href="<?php  echo url('article/news-show/detail', array('id' => $new['id']));?>"><?php  echo $new['title'];?></a></li>
...
<div class="clearfix welcome-container"> <?php  if($do != 'ext') { ?>
