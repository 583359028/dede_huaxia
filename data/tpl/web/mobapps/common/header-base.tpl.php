...
<html lang="zh-cn">
    ...
    <title><?php  if(isset($title)) $_W['page']['title'] = $title?><?php  if(!empty($_W['page']['title'])) { ?><?php  echo $_W['page']['title'];?> - <?php  } ?><?php  if(empty($_W['page']['copyright']['sitename'])) { ?><?php  if(IMS_FAMILY != 'x') { ?>米云微信公众号管理系统 - 技术支持QQ：1205450779<?php  } ?><?php  } else { ?><?php  echo $_W['page']['copyright']['sitename'];?><?php  } ?></title>
    ...
    <meta name="description" content="<?php  if(empty($_W['page']['copyright']['description'])) { ?><?php  if(IMS_FAMILY != 'x') { ?>米云微营销是国内最完善移动网站及移动互联网技术解决方案。<?php  } ?><?php  } else { ?><?php  echo $_W['page']['copyright']['description'];?><?php  } ?>" />
	...
	<![endif]-->
    <!--模板-->
    <link href="./themes/mobapps/static/css/bootstrap.min.css" rel="stylesheet">
    <link href="./themes/mobapps/static/css/bootstrap-reset.css" rel="stylesheet">
    <link href="./themes/mobapps/static/css/style.css" rel="stylesheet">
    <link href="./themes/mobapps/static/css/style-responsive.css" rel="stylesheet">
    <!--模板结束-->
