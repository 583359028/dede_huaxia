...
<div class="clearfix">
	<form action="" method="post"  class="form-horizontal" role="form" enctype="multipart/form-data" id="form1">
			...
			<div class="modal-dialog">
				<div class="modal-content" style="width:740px;">
					...
					<div class="modal-body">
						...
						<span class="help-block"><?php  if(IMS_FAMILY == 'x') { ?>欢迎关注<?php  echo $account['name'];?><?php  } else { ?>微信是一款免费开源的微信公众平台管理系统。<?php  } ?></span>
					</div>
		...
		<div class="form-group">
				<label class="col-xs-12 col-sm-3 col-md-2 control-label">文件名</label>
				<div class="col-sm-9 col-xs-12">
					<input type="text" class="form-control" value=""  autocomplete="off" name="namesss"/>
					<div class="help-block"></div>
					<span class="help-block">例如要上传的文件为“ MP_verify_Eulz2x-0ZkBFWHH2.txt” 那么此处填写 “ MP_verify_Eulz2x-0ZkBFWHH2 ”  </span>
					
				</div>
				
			</div>
			<div class="form-group">
				<label class="col-xs-12 col-sm-3 col-md-2 control-label">文件内容</label>
				<div class="col-sm-9 col-xs-12">
				<!-- <textarea name="contentss" style="width:300px;height:300px;"></textarea> -->
					<input type="text" class="form-control" value=""  autocomplete="off" name="contentss"/>
					<div class="help-block"></div>
					
					<span class="help-block">打开txt文件，把里面显示的内容复制到此处，例如：Eulz2x/0ZkBFWHH2 切记不要出现空格 </span>
